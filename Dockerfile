...
ENV AWS_BASE_INSTANCE="t2.micro"
ENV AWS_KEY_PAIR=
ENV AWS_MANAGER_INSTANCE_TYPES="{}"
ENV AWS_MANAGER_NAME="Docker manager"
ENV AWS_REGION="eu-west-1"
ENV AWS_SECRET_KEY=
ENV AWS_WORKER_INSTANCE_TYPES="{}"
ENV AWS_WORKER_NAME="Docker worker"
...
ENV DOCKER_VERSION_TYPE=stable # Can also be edge
ENV CPU_TYPE=amd64
